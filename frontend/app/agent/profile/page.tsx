...
export default function AgentProfilePage() {
  ...
  const fetchProfileData = async () => {
    ...
    try {
      ...
      const allSubareas = await estateApi.content.subareas.list() as unknown as Subarea[];
      ...
      const allProperties = await estateApi.adminProperties.list() as unknown as Property[];
      ...
      const allAppointments = await estateApi.appointments.list() as unknown as Appointment[];
